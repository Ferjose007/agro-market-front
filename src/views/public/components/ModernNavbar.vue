...
<template>
    ...
    <nav :class="[
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-24">
                ...
                <router-link to="/" class="flex items-center gap-3 group">
                    <img :src="logoUrl" alt="AgroMarket Logo" class="h-16 md:h-20 w-auto object-contain transition-transform duration-300 group-hover:scale-105" />
                </router-link>
                ...
                <div class="md:hidden flex items-center">
                    <button @click="toggleMenu" :class="['focus:outline-none p-2 rounded-lg transition-colors', isScrolled ? 'text-gray-600 hover:bg-gray-100' : 'text-white hover:bg-white/10']">
        ...
        <transition enter-active-class="transition duration-300 ease-out" enter-from-class="opacity-0 -translate-y-4"
            ...
            <div v-if="isMenuOpen" class="md:hidden bg-white/95 backdrop-blur-xl border-t border-gray-100 shadow-2xl absolute w-full left-0 top-full">
